...
public class BerlinClockFixture {
    ...
    public void thenTheClockShouldLookLike(String theExpectedBerlinClockOutput) {
    	...
    	//Added code here to ensure that the test case doesn't break because of escape characters
    	String time = berlinClock.convertTime(theTime);
    	time = time.replaceAll("\\s", "");
    	theExpectedBerlinClockOutput = theExpectedBerlinClockOutput.replaceAll("\\s", "");
